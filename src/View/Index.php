...
class Index extends View
{
    ...
    public function getContent()
    {
        ...
        <div class="note bg-primary">
            ...
            <div class="video-annotation"><div class="btn btn-success" data-key="65" data-shortcut="a" onclick="$('.annotation').toggleClass('hidden'); setAnnotationTime();"><strong>A</strong>dd Annotation</div></div>
